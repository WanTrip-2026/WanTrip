...
const props = defineProps({
  ...
  initialTicketGuests: { type: Object as () => { adults: number; children: number; hasPet: boolean }, default: () => ({ adults: 2, children: 0, hasPet: false }) },
})
...
const allCities = [
  { region: '北部', cities: ['基隆市', '台北市', '新北市', '桃園市', '新竹市', '新竹縣', '宜蘭縣'] },
                ...
                >
                    ...
                    <div v-if="!ticketSearchKeyword" class="mb-4">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <button
                                v-for="city in hotCities" :key="city"
        ...
        <div class="relative flex-[1.5]">
            ...
            >
                ...
                <div class="flex items-center justify-between pointer-events-none">
                    <span class="text-base font-medium text-black truncate">{{ ticketGuestDisplay }}</span>
                     <svg
             ...
             <transition name="fade">
                ...
                >
                    ...
                    <!-- Pet -->
                    <div class="flex items-center justify-between cursor-pointer" @click="ticketGuests.hasPet = !ticketGuests.hasPet">
                        <div>
