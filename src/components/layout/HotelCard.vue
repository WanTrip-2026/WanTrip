...
<template>
  <div class="flex flex-col w-[894px]">
    <div class="bg-white h-[180px] rounded-[20px] border border-gray-200 overflow-hidden flex flex-row">
      <!-- 圖片 -->
        ...
        <div class="flex flex-col justify-end items-end gap-2">
          ...
          <div class="flex gap-4">
            ...
            <RouterLink :to="`/hotels/${hotel.id}`">
              <button class="bg-primary text-white px-6 py-2 rounded-[20px] hover:bg-main_800 transition">
                查看空房情況
              </button>
            </RouterLink>
          </div>
