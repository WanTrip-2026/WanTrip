    ...
    <div class="max-w-[1240px] mx-auto px-5 mb-20">
      ...
      <section class="mt-20">
        ...
        <div class="grid grid-cols-2 gap-5 sm:grid-cols-3 lg:grid-cols-6">
          ...
          >
            <div
              class="relative overflow-hidden rounded-[25px] bg-white/70 border border-gray-300 transition-shadow duration-200"
          ...
          <div class="w-[40%] h-full p-6 flex flex-col">
            ...
            <div class="flex items-end justify-between">
              ...
              <div class="text-right">
                <div class="text-xl font-black text-red-500">NT$ {{ hoverHotel.price ?? 6166 }}</div>
...
const hotHotelsB: Hotel[] = [
  { id: 7, name: "台北君悅酒店", city: "台北市", imageUrl: "https://picsum.photos/600/400?random=1" },
  { id: 8, name: "晶華酒店", city: "台北市", imageUrl: "https://picsum.photos/600/400?random=2" },
  { id: 9, name: "日月潭涵碧樓", city: "南投縣", imageUrl: "https://picsum.photos/600/400?random=3" },
  { id: 10, name: "台南晶英酒店", city: "台南市", imageUrl: "https://picsum.photos/600/400?random=7" },
  { id: 11, name: "礁溪寒沐酒店", city: "宜蘭縣", imageUrl: "https://picsum.photos/600/400?random=8" },
  { id: 12, name: "墾丁凱撒大飯店", city: "屏東縣", imageUrl: "https://picsum.photos/600/400?random=9" },
];
...
function setCardEl(index: number, el: HTMLElement | null) {
