            ...
            <form class="max-w-md space-y-4 justify-between pt-5 flex flex-col gap-2" @submit.prevent="saveProfile">
              ...
              <div>
                ...
                <input id="fullName" name="fullName" :disabled="!isEditing" type="text" required placeholder="請輸入姓名"
                  class="w-full rounded-full border border-gray-300 px-5 py-3" v-model="form.fullName" />
              </div>
              <!-- 生日 -->
              <div>
                ...
                <input id="birthday" name="birthday" :disabled="!isEditing" type="date" required
                  class="w-full rounded-full border border-gray-300 px-5 py-3" v-model="form.birthday" />
              </div>
              <!-- 性別 -->
              <div>
              ...
              <div>
                ...
                <input id="phone" name="phone" :disabled="!isEditing" type="tel" required placeholder="請輸入電話號碼"
                  class="w-full rounded-full border border-gray-300 px-5 py-3" v-model="form.phone" />
              </div>
            ...
            <div class="flex flex-col gap-2.5 py-5">
              <div class="flex justify-between rounded-[20px] border border-gray-300 overflow-hidden">
                <div class="flex h-[120px]">
                  <img class="aspect-[4/3] object-cover min-w-10" src="../../assets/hoteldetail_img/Wanhao.jpg"
                    alt="產品照片" />
                  <div class="flex flex-col justify-center gap-1 px-5">
                    <h3 class="text-md lg:text-xl font-bold">飯店名稱：高雄洲際飯店</h3>
                ...
                <div class="flex flex-col justify-center gap-2 px-5">
                  ...
                  <button class="text-nowrap hover:text-main_800">再次訂購</button>
                </div>
              </div>
              <!-- 複製 -->
              <div class="flex justify-between rounded-[20px] border border-gray-300 overflow-hidden">
