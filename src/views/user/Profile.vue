    ...
    <section class=" mx-5">
      <div class="relative grid grid-cols-1 lg:grid-cols-4 gap-5">
        ...
        <div class="lg:col-span-3 gap-10 pb-10">
          <!-- 帳號管理區 -->
          <div class="scroll-mt-[96px] bg-white w-full rounded-[20px] border border-gray-300 p-5 mb-10"
            id="account-section">
            ...
            <form class="max-w-md space-y-4 justify-between pt-5 flex flex-col gap-2">
              ...
              <div>
                ...
                <input id="currentPassword" type="password" required minlength="8" placeholder="請輸入原密碼"
                  class="w-full rounded-full border border-gray-300 px-5 py-3" />
              </div>
              <!-- Password -->
              <div>
                <label for="newPassword" class="block mb-1 font-medium">新密碼</label>
                <input id="newPassword" name="password" type="password" required minlength="8" placeholder="至少 8 碼"
                  class="w-full rounded-full border border-gray-300 px-5 py-3" />
              </div>
              ...
              <div>
                ...
                <input id="confirmPassword" name="confirmPassword" type="password" required minlength="8"
                  placeholder="請再次輸入密碼" class="w-full rounded-full border border-gray-300 px-5 py-3" />
              </div>

              <button type="submit" class="self-end rounded-full bg-primary hover:bg-main px-4 py-2 text-white">
                修改密碼
              </button>
            </form>
          </div>
          <!-- 我的訂單 -->
          <div class="scroll-mt-[96px] bg-white rounded-[20px] border border-gray-300 p-5 mb-10" id="order-section">
            <h3 class="font-bold text-2xl border-b-gray-300 border-b-2 pb-2">我的訂單</h3>
            <div class="flex flex-col gap-2.5 py-5">
              <div class="flex justify-between rounded-[20px] border border-gray-300 overflow-hidden">
                <div class="flex h-[120px]">
                  <img class="object-cover min-w-10" src="../assets/hoteldetail_img/Wanhao.jpg" alt="產品照片" />
                  <div class="flex flex-col justify-center gap-1 px-5">
                    <h3 class="text-md hover:text-xl font-bold">飯店名稱：高雄洲際飯店</h3>
                    <p class="text-sm">訂單編號：202512240001</p>
                    <p class="text-sm">訂單日期：2025年12月24日</p>
                  </div>
                </div>
                <div class="flex flex-col justify-center gap-2 px-5">
                  <button class="text-nowrap">訂單詳情</button>
                  <button class="text-nowrap">取消訂單</button>
                  <button class="text-nowrap">再次訂購</button>
                </div>
              </div>
              <!-- 複製 -->
              <div class="flex justify-between rounded-[20px] border border-gray-300 overflow-hidden">
          ...
          <div class="scroll-mt-[96px] bg-white rounded-[20px] border border-gray-300 p-5 mb-10" id="favorite-section">
            ...
            <div class="flex gap-2.5 mt-5 overflow-x-auto flex-nowrap">
              <div class="w-[240px] shrink-0 rounded-[20px] border border-gray-300 overflow-hidden">
                <img class="aspect-[4/3] object-cover" src="../assets/hoteldetail_img/Wanhao.jpg" alt="產品照片" />
                <div class="flex flex-col p-2.5 gap-1">
                  <h3 class="text-md font-bold text-nowrap">飯店名稱：高雄洲際飯店</h3>
                  <p class="text-sm">高雄市前鎮區</p>
                  <div class="flex gap-2 justify-center items-center">
                    <button class="rounded-[20px] bg-dark_100 hover:bg-dark_300 text-dark w-full py-2">
                      取消收藏
                    </button>
          ...
          <!-- 個資管理區 -->
          <div class="scroll-mt-[96px] bg-white w-full rounded-[20px] border border-gray-300 p-5" id="admin-section">
            <button type="button" class="float-right text-dark_700 font-medium" @click="toggleEdit">
              {{ isEditing ? '取消' : '編輯' }}
            </button>
              ...
              <div>
                ...
                <div class="flex items-center gap-4">
                  <label class="flex items-center gap-1">
                    <input type="radio" :disabled="!isEditing" name="gender" v-model="gender" value="male"
                      class="accent-primary" required />
                    男
                  </label>
                  <label class="flex items-center gap-1">
                    <input type="radio" name="gender" v-model="gender" value="female" class="accent-primary" />
                    女
                  </label>
                </div>
              </div>
