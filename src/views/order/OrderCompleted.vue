      ...
      <div
        ...
        <div class="flex flex-col gap-2 items-center lg:flex-row lg:gap-6 lg:justify-start w-full">
          <div class="w-[200px] aspect-[1/1] overflow-hidden">
            <img src="/src/assets/hoteldetail_img/Wanhao.jpg" alt="訂購飯店圖"
              class="w-full h-full object-cover rounded-[20px]" />
          </div>

          <div class="flex flex-col items-center lg:items-stretch flex-nowrap gap-2 text-base text-nowrap">
            ...
            <div class="flex flex-col items-center lg:items-stretch gap-1">
              ...
              <p class="text-dark_700 text-base">{{ order.address }}</p>
        ...
        <div class="flex gap-2">
          <router-link to="/" class="rounded-full bg-primary text-white px-12 py-3 inline-block hover:bg-main">
            回到首頁
          </router-link>
