        ...
        <section class="bg-white p-5 rounded-[20px] shadow-sm border border-gray-300">
          ...
          <div class="space-y-6 mt-4">
            <div v-for="detail in ticketDetail" :key="detail.id">
              <div v-if="detail.type === 'text'" class="prose max-w-none text-gray-600 text-sm leading-relaxed">
        ...
        <section>
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-5">
            <RouterLink v-for="recommend in recommendations" :key="recommend.id" :to="`/ticket/${recommend.id}`"
              ...
              <div class="p-5">
                <div class="text-sm font-bold truncate mb-1 text-gray-800 group-hover:text-[#365475] transition-colors">
                  {{ recommend.title }}
                </div>
                <div class="text-xs text-gray-500 font-medium">
                  TWD {{ recommend.price }} 起
                </div>
              </div>
            </RouterLink>
          </div>
