...
const menus = [
  { label: '我的帳號', href: '#account-section' },
  { label: '我的訂單', href: '#order-section' },
  { label: '收藏清單', href: '#favorite-section' },
  { label: '個資管理', href: '#admin-section' },
]
        ...
        >
          <a
            ...
            :class="[
              ...
              activeMenu.value === menu.href ? 'bg-primary text-white' : 'bg-gray-200',
            ]"
            >{{ menu.label }}
          </a>
        </aside>
